...
// MARK: - More Achievements

extension AchievementType {
    static let allAchievements: [AchievementType] = [
        // Focus achievements
        .firstFocus, .focusMaster, .steadyGaze, .multiTasker, .speedDemon,
        
        // Streak achievements  
        .firstStreak, .weekStreak, .monthStreak, .centuryStreak,
        
        // Challenge achievements
        .firstChallenge, .tenChallenges, .hundredChallenges, .thousandChallenges,
        
        // Score achievements
        .perfectScore, .highScorer, .comboMaster, .unstoppable,
        
        // Special achievements
        .earlyBird, .nightOwl, .weekendWarrior, .dedicated,
        
        // Social achievements (future)
        // .socialButterfly, .mentor, .leader
    ]
    
    var tier: AchievementTier {
        switch self {
        case .firstFocus, .firstStreak, .firstChallenge:
            return .bronze
        case .focusMaster, .weekStreak, .tenChallenges, .perfectScore:
            return .silver
        case .steadyGaze, .monthStreak, .hundredChallenges, .highScorer:
            return .gold
        default:
            return .platinum
        }
